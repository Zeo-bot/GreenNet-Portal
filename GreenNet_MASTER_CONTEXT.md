...
1. Migrate `AdminUserManagerPasswordController` as the second guarded production write path. Verify password redaction in sessions, audits, result DTOs, raw temporary SQLite bytes, and a separately authorized Lab Router lifecycle.
