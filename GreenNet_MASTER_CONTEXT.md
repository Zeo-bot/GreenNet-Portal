...
1. Continue migrating remaining legacy RouterOS write controllers through the guarded gateway, preserving exact command policy, partial-failure reporting, and separately authorized cleanup validation.
