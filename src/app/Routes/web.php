...
$router->post('/admin/backup/create', [AdminBackupController::class, 'createStored']);
$router->post('/admin/backup/upload', [AdminBackupController::class, 'upload']);
$router->post('/admin/backup/restore-stored', [AdminBackupController::class, 'restoreStored']);
$router->post('/admin/backup/delete', [AdminBackupController::class, 'deleteStored']);
...
$router->get('/admin/routers', [AdminRoutersController::class, 'index']);
